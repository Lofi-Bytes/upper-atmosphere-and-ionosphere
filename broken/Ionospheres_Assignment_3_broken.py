...
H = {'O':((k*T)/(m['O']*g)),'N':((k*T)/(m['N']*g)),
     'O2':((k*T)/(m['O2']*g)),'N2':((k*T)/(m['N2']*g)),
'NO':((k*T)/(m['NO']*g))}    
...
# in units of [kg].
M = m['O']*(n['O']/N_tot) + m['N']*(n['N']/N_tot)\
 + m['O2']*(n['O2']/N_tot) + m['N2']*(n['N2']/N_tot)\
 + m['NO']*(n['NO']/N_tot)
...
#N+ Ionization Rates
R37 = 3.07E-10 ; M37 = n['O2']  # N+ + O2 -> O2+ + N
R38 = 2.32E-10 ; M38 = n['O2']    # N+ + O2 -> NO+ + O 
R39 = 4.6E-11 ; M39 = n['O2']     # N+ + O2 -> O+ + NO

#N2+ Ionization Rates
R43 = 4.1E-10 ; M43 = n['NO']     # N2+ + NO -> NO+ + N2
R44 = 1.3E-10 ; M44 = n['O']     # N2+ + O -> NO+ + N
R45 = 9.8E-12 ; M45 = n['O']     # N2+ + O -> O+ + N2
R46 = 5.0E-11 ; M46 = n['O2']     # N2+ + O2 -> O2+ + N2

#O+ Ionization Rates
R47 = 1.2E-12 ; M47 = n['N2']     # O+ + N2 -> NO+ + N
R48 = 2.1E-11 ; M48 = n['O2']     # O+ + O2 -> O2+ + O
R49 = 8.0E-13 ; M49 = n['NO']     # O+ + NO -> NO+ + O

#O2+ Ionization Rate
R52 = 4.6E-10 ; M52 = n['NO']     # O2+ + NO -> NO+ + O2
R53 = 1.5E-10 ; M53 = n['N']     # O2+ + N -> NO+ + O

#for i in range()
#N[i+1] = (N[i] + S*(time[i] - time[i-1]))/(1 + R*M*(time[i] - time[i-1])) 
...
for loop in range(tloop):
    ...
    rho = {'O':(n['O']*m['O']),'N':(n['N']*m['N']),
           'O2':(n['O2']*m['O2']),'N2':(n['N2']*m['N2']),
    'NO':(n['NO']*m['NO'])}
    # Calculating and array containing the total number density as it
    # changes with altitude in [m^-3].
    N_tot = n['O'] + n['N'] + n['O2'] + n['N2'] + n['NO']
...
Assignment 3/Figures/T_max_vs_tim.eps')